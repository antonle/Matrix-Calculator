...
complexNumber& complexNumber::operator*=(const complexNumber& rhs) {
	float real = re();
	float imag = im();
	real_ = real * rhs.real_ - imag * rhs.imaginary_;
	imaginary_ = real * rhs.imaginary_ + imag * rhs.real_;
...
complexNumber& complexNumber::operator/=(const complexNumber& rhs) {
	...
	real_ = (real * rhs.real_ + imag * rhs.imaginary_) / (len * len);
	imaginary_ = (imag * rhs.real_ - real * rhs.imaginary_) / (len * len);
